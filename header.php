...
<!doctype html>
<!--[if IE 6]>
<html id="ie ie6" <?php language_attributes(); ?>>
<![endif]-->
<!--[if IE 7]>
<html id="ie ie7" <?php language_attributes(); ?>>
<![endif]-->
<!--[if IE 8]>
<html id="ie ie8" <?php language_attributes(); ?>>
<![endif]-->
<!--[if !(IE 6) | !(IE 7) | !(IE 8) ]><!-->
...
<body <?php body_class(); ?>>
<div id="wrapper">
    <header id="branding" class="g12" role="banner">
        <hgroup>
